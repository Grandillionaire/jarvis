...
- **Phone control.** Drive it from Telegram or Discord, owner-allowlisted. Remote turns are sandboxed — never unrestricted shell, no computer-use — so a message can read, search, and take notes but can't touch your machine.
